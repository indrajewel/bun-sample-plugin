...
**Note**: This sample project has specific technical dependencies on Bun. If you're creating a plugin from scratch, you can choose different tools, but you'll need to replace the build configuration accordingly.
...
- To use [Biome](https://biomejs.dev/), install it from terminal: `bun add -D -E @biomejs/biome`.
...
- Obsidian sample plugin using npm: https://github.com/obsidianmd/obsidian-sample-plugin
